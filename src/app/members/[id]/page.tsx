            ...
            <div className="animate-fade-in p-4">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    <div className="lg:col-span-2 glass-card p-6 space-y-4">
                        {[0, 1, 2].map(i => <Skeleton key={i} className="h-14 w-full rounded" />)}
                    </div>
                        ...
                        <div className="space-y-4">
                            {member.contributedRepos.length > 0 ? (
                                member.contributedRepos.map(repoName => (
                                    <div key={repoName} className="flex items-center justify-between p-4 rounded bg-secondary/20 border border-border/50 hover:border-primary/30 transition-all group">
                                        <div>
