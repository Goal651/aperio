...
export default function Page() {
    ...
    return (
        <DashboardLayout>
            {/* Header */}
            <div className="mb-8 p-4 md:p-0 bg-secondary/5 md:bg-transparent rounded border md:border-0 border-border/40">
            ...
            <div className="glass-card p-4 md:p-8 animate-fade-in" style={{ animationDelay: "0.3s" }}>
                ...
                <div className="flex flex-col lg:flex-row gap-4 mb-6">
                    <div className="relative flex-1">
                        ...
                        <Input
                            ...
                            className="pl-10 h-11 bg-secondary/20 border-border/50 focus:border-primary/40 rounded"
                            value={searchQuery}
                    ...
                    <div className="flex items-center gap-2">
                        <select
                            className="flex-1 lg:flex-none bg-secondary/20 border border-border/50 rounded px-4 h-11 text-sm font-medium outline-none focus:ring-2 focus:ring-primary/20 transition-all cursor-pointer"
                            value={sortBy}
                ...
                {/* Desktop Table */}
                <div className="hidden md:block overflow-hidden rounded border border-border/50">
                    <Table>
                ...
                <div className="md:hidden space-y-4">
                    {loadingStates.fetchingMembers ? (
                        [0, 1, 2].map(i => (
                            <div key={i} className="p-4 rounded bg-secondary/10 border border-border/40 space-y-4">
                                <div className="flex items-center gap-3">
                        ...
                        <div className="py-12 text-center text-muted-foreground text-sm font-medium bg-secondary/5 rounded border border-dashed border-border/50">
                            No members found.
                        </div>
                    ) : (
                        filteredMembers.map((member, idx) => (
                            <div
                                key={member.username}
                                className="p-5 rounded bg-secondary/10 border border-border/40 active:bg-secondary/20 transition-all space-y-5 animate-fade-in group"
