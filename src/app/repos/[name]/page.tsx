                    ...
                    <div className="glass-card p-6">
                        ...
                        {loadingStates.fetchingAlerts ? (
                            <div className="space-y-4">
                                {[0, 1, 2].map(i => (
                                    <div key={i} className="p-4 rounded bg-secondary/20 border border-border/50">
                            ...
                            <div className="space-y-4">
                                {alerts.map(alert => (
                                    <div key={alert.id} className="p-4 rounded bg-secondary/20 border border-border/50 hover:border-primary/30 transition-all">
