                        ...
                        <div className="max-w-3xl relative z-10">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 pt-12 mt-4 border-t border-border/40">
                                ...
                                >
                                    ...
                                    <span className="uppercase  text-[10px]">Save & Recalculate</span>
                                </Button>
                                <Button
                                    variant="outline"
                ...
                <TabsContent value="organization" className="animate-fade-in outline-none">
                    <div className="glass-card p-1 relative overflow-hidden group">
                        <div className="p-6 md:p-10 space-y-10">
                            ...
                            <div className="flex items-center gap-4 p-5 rounded bg-primary/5 border border-primary/10 text-primary group/info">
                                <div className="p-2 bg-primary/10 rounded group-hover/info:scale-110 transition-transform">
                ...
                <TabsContent value="appearance" className="animate-fade-in outline-none">
                    <div className="glass-card p-6 md:p-10 relative overflow-hidden group">
                        <div className="max-w-3xl space-y-10">
                            ...
                            <div className="flex items-center justify-between p-6 rounded bg-secondary/10 border border-border/40 hover:bg-secondary/20 transition-all group/switch">
                                <div className="space-y-1">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div className="p-5 rounded border border-border/40 bg-secondary/5 opacity-50 flex items-center gap-4 cursor-not-allowed group/item">
                                    <div className="p-2 bg-background rounded border border-border/20">
