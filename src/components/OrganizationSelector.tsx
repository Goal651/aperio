  ...
  if (isLoading || loadingStates.fetchingOrgData || loadingStates.fetchingMembers || loadingStates.fetchingAlerts) {
    return (
      <div className="w-full max-w-2xl mx-auto glass-card p-12 text-center">
        ...
        <h2 className="text-md font-semibold text-foreground tracking-tight">Synchronizing Organization</h2>
  ...
  if (state.installationStatus === 'checking') {
    return (
      <div className="w-full max-w-2xl mx-auto glass-card p-12 text-center">
        ...
        <h2 className="text-md font-semibold text-foreground tracking-tight">Discovering Installations</h2>
    ...
    return (
      <div className="w-full max-w-2xl mx-auto glass-card p-1 md:p-1 relative overflow-hidden group border-destructive/20 bg-destructive/5">
        <div className="p-8 md:p-10 text-center">
          ...
          <h2 className="text-md font-semibold text-foreground tracking-tight mb-2">Connection Interrupted</h2>
          ...
          <Button
            ...
            variant="destructive"
            className="h-12 px-8 rounded font-semibold uppercase  text-[10px] shadow-lg shadow-destructive/20 transition-all hover:scale-105 active:scale-95"
          >
      ...
      <div className="w-full max-w-3xl mx-auto glass-card p-1 relative overflow-hidden group">
        <div className="p-6 md:p-10">
          <div className="flex items-center gap-4 mb-8">
            ...
            <div>
              <h2 className="text-md font-semibold text-foreground tracking-tight">Select Organization</h2>
                ...
                <div className="flex items-center gap-5 relative z-10">
                  <div className="relative">
                    <Avatar className="h-14 w-14 rounded border-2 border-background shadow-md">
                      ...
                      />
                      <AvatarFallback className="bg-primary/20 text-primary font-semibold rounded">
                  ...
                  <div>
                    <div className="font-semibold text-lg text-foreground tracking-tight group-hover/item:text-primary transition-colors">@{installation.organizationLogin}</div>
                    <div className="text-[10px] font-semibold uppercase  text-muted-foreground opacity-60">
                ...
                <div className="flex items-center gap-3 relative z-10">
                  {state.installationId === installation.installationId && (
                    <div className="hidden sm:flex items-center gap-2 px-3 py-1.5 bg-success/10 border border-success/20 rounded">
                      ...
                      <span className="text-[10px] font-semibold uppercase  text-success">Current Target</span>
                    </div>
                  )}
          ...
          <div className="mt-10 pt-8 border-t border-border/40">
            <Button
              ...
              variant="glow"
              className="w-full h-14 rounded gap-3 bg-secondary/10 hover:bg-secondary/20 border-border/40 text-foreground font-semibold uppercase  text-[11px] transition-all hover:scale-[1.01] active:scale-95"
            >
  ...
  return (
    <div className="w-full max-w-2xl mx-auto glass-card p-1 relative overflow-hidden group">
      <div className="p-8 md:p-12 text-center">
        ...
        <h2 className="text-md font-semibold text-foreground tracking-tight mb-3">No Target Found</h2>
        ...
        <Button
          onClick={installToOrganization}
          variant="glow"
          className="w-full md:w-auto h-14 px-12 rounded gap-3 bg-primary text-primary-foreground font-semibold uppercase  text-[11px] shadow-xl shadow-primary/20 hover:scale-105 active:scale-95 transition-all"
        >
