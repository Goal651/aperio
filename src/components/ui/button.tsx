...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant, size, asChild = false, ...props }, ref) => {
    ...
    return <Comp className={cn(buttonVariants({ variant, size, className }), "glass-card hover:border-primary/30 transition-all cursor-pointer animate-fade-in")} ref={ref} {...props} />;
  },
);
